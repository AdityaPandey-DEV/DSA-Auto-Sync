...
def update_main_readme(leetcode_count, codeforces_count, geeksforgeeks_count):
    ...
    try:
        ...
        def replace_gfg(match):
            return f"{match.group(1)}{match.group(2)}{geeksforgeeks_count}{match.group(4)}"
...
def main():
    ...
    print(f"📈 Statistics:")
    print(f"  LeetCode: {leetcode_stats['total']} total ({leetcode_stats['easy']} easy, {leetcode_stats['medium']} medium, {leetcode_stats['hard']} hard)")
    print(f"  Codeforces: {codeforces_count}")
    print(f"  GeeksforGeeks: {geeksforgeeks_count}")
    print(f"  Total: {leetcode_stats['total'] + codeforces_count + geeksforgeeks_count}\n")
    ...
    if update_main_readme(leetcode_stats['total'], codeforces_count, geeksforgeeks_count):
